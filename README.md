...
# 👋🏽 Hello, I'm Loay Abdulkhaleq Al-Jadebi
...
| :--- | :--- | :--- |
| **Laravel** • PHP • Livewire • MySQL | **Flutter** • HTML5 • CSS3 • JavaScript  | Git • Windows Server • Firebase  |

**Architecture:** RESTful APIs • Database Schema Design • Clean Code 
**Practices:** Agile • Business Operations Management • Technical Support 

---

### 📚 Currently Learning & Developing

- 🚀 **Advanced System Architecture** & Scalable Applications.
- 🛠️ **MASABIE OS**: Enterprise Inventory & Maintenance System.
- ⚖️ **Aqd-sys**: Legal Contract Management with Laravel. 
...
| :--- | :--- | :--- |
| ⚖️ **Aqd-sys** | Laravel • PrimeNG | [cite_start]Secure platform for legal contract documentation. |
| 🛒 **E-Commerce** | Laravel • Livewire | [cite_start]Integrated system with cart and responsive UI. |
| 📱 **Maintenance App** | Flutter • Firebase | Offline-first system for device & inventory tracking. |
